...
public class ToUpperCaseDeserializerTest {
    ...
    @Test
    public void testDeserializeWithEmptyString() throws IOException {
        String input = "";
    ...
    @Test
    public void testDeserializeWithNull() throws IOException {
